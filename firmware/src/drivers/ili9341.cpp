...
// Standard ILI9341 bring-up (same sequence the Adafruit driver uses). MADCTL 0xE8 = MY|MX|MV|BGR,
// landscape rotated 180 degrees so the face is upright from the chair the desk faces.
const Step kInit[] = {
    ...
    {0xC7, 1, {0x86}, 0}, {0x36, 1, {0xE8}, 0}, {0x37, 1, {0x00}, 0}, {0x3A, 1, {0x55}, 0},
